...
import { BsInfoCircleFill, BsCheckCircleFill, BsChevronDown } from "react-icons/bs";
        ...
        <form action="" onSubmit={handleFormSubmit}>
          <div>
            ...
            <INPUT type="email"   width="100%" required />
              <label htmlFor="We'll" style={{display:"flex" ,marginTop:"-20px"}}>We'll send the purchase receipt to this email.</label>
            <label htmlFor="country" style={{ display: "flex", marginTop:"20px"}}>* Country/Region</label>
            ...
            <label htmlFor="name" style={{ display: "flex" }}>* Full Name</label>
            <INPUT
              type="text"
              ...
              required
            />
            <label htmlFor="Address" style={{ display: "flex" }}>* Address Search</label>
            <INPUT
              type="text"
              ...
              required
            />
            <label htmlFor="Address" style={{ display: "flex" }}> Apartment/Suite number</label>
            <INPUT
              type="text"
              // placeholder="start typing your address..."
              width="96%"
            />
             <label htmlFor="Address" style={{ display: "flex" }}>* Town/City</label>
            <INPUT
              type="text"
              // placeholder="start typing your address..."
              width="96%"
              required
            />
             <label htmlFor="Address" style={{ display: "flex" }}>* State</label>
             <SELECT1 type="text" width="96%" required>
            ...
            <label htmlFor="Zip Code/Postcode"  style={{ display: "flex" }}>* Zip Code/Postcode</label>
            <INPUT type="text" width="96%" required />
            <label htmlFor="contact number"  style={{ display: "flex" }}>* Contact Number</label>
            <INPUT type="text" width="96%" required />
            <p style={{ display: "flex", fontSize:"14px", fontWeight:"400", lineHeight:"14px" }}>Why do we need your number?</p>
          </div>
          <div style={{width:"80%"}}>
            <h3 style={{ marginBottom: "20px",
                display: "flex",
                fontFamily: "serif",}}>2. Select Delivery Option</h3>
            <div>
              <section>
                <BsInfoCircleFill />
              </section>
          ...
          <div style={{width:"80%"}}>
            <h3 style={{ marginBottom: "20px",
                display: "flex",
                fontFamily: "serif",}}>3. Select Payment Method</h3>
            <div1>
              <h2>
                <BsCheckCircleFill />
              </h2>
              ...
              <br />
              <label htmlFor="card number" style={{display:"flex"}}>* Card Number</label>
              <INPUT type="text" width="98%" required />
              <label htmlFor="name on card" style={{display:"flex"}} >* Name on card</label>
              <INPUT type="text" width="98%" required />
              <label htmlFor="expiry date" style={{display:"flex"}}>* Expiry Date</label>
              <br />
              ...
              <label htmlFor="security code" style={{marginRight:"370px"}}>*Security Code (CV2)</label>
              <br />
              <div1 style={{display:"flex"}}>
              <INPUT type="text" width="46%" required style={{marginRight:"370px"}}/>
              {/* <section >
            ...
            <div style={{border:"1px solid black", width:"90%"}}>
              <h4 style={{marginBottom: "50px",
                display: "flex",
                fontFamily: "serif"}}>Use a different payment method <section style={{marginLeft:"280px", fontWeight:"bold"}}>
                  <BsChevronDown/>
                </section></h4>
               <div1 style={{display:"flex"}}>
              <img
          ...
          <p style={{display:"flex", marginLeft:"100px"}}>By placing this order, you are confirming that you agree to our</p>
          <p style={{display:"flex", marginLeft:"150px", textDecoration:"underline"}}>Terms and Conditions and Privacy Policy.</p>
        </form>
